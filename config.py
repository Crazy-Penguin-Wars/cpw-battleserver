...
MAX_FRAME_BYTES = int(os.getenv("MAX_FRAME_BYTES", str(1024 * 1024)))
READ_TIMEOUT_SECONDS = float(os.getenv("READ_TIMEOUT_SECONDS", "30"))
HTTP_TIMEOUT_SECONDS = float(os.getenv("HTTP_TIMEOUT_SECONDS", "5"))
DEFAULT_BATTLE_TIME_SECONDS = int(os.getenv("DEFAULT_BATTLE_TIME_SECONDS", "60"))
DEFAULT_TURN_TIME_SECONDS = int(os.getenv("DEFAULT_TURN_TIME_SECONDS", "20"))
